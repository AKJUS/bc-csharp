...
namespace Org.BouncyCastle.Tsp.Tests
{
    public class TspTestUtil
    {
        ...
        internal static CipherKeyGenerator rc264kg;
        internal static CipherKeyGenerator rc2128kg;

        internal static int serialNumber;

        public static readonly bool Debug = true;

        public static readonly DerObjectIdentifier EuroPkiTsaTestPolicy =
            new DerObjectIdentifier("1.3.6.1.4.1.5255.5.1");
        ...
        public static string GetDigestAlgName(string digestAlgOid) =>
            CollectionUtilities.GetValueOrKey(DigestAlgs, digestAlgOid);

        public static string GetEncryptionAlgName(string encryptionAlgOid) =>
            CollectionUtilities.GetValueOrKey(EncryptionAlgs, encryptionAlgOid);
        ...
        public static KeyParameter MakeDesede192Key() => new DesEdeParameters(desede192kg.GenerateKey());

        public static KeyParameter MakeRC240Key() => new RC2Parameters(rc240kg.GenerateKey());

        public static KeyParameter MakeRC264Key() => new RC2Parameters(rc264kg.GenerateKey());

        public static KeyParameter MakeRC2128Key() => new RC2Parameters(rc2128kg.GenerateKey());
        ...
        public static X509Certificate MakeCertificate(AsymmetricCipherKeyPair _subKP, string _subDN,
            AsymmetricCipherKeyPair _issKP, string _issDN, bool _ca)
        {
